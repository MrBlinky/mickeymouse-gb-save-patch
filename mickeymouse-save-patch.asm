;---------------------------------------------------------------
;Save and reset patch for Mickey Mouse (UE), Mickey Mouse 2,
;Hugo and Bugs Bunny Crazy Castle         by Mr.Blinky Nov.2024
;
;use RGBASM to build
;
;---------------------------------------------------------------
...
;-------------------------------------------------------------------------------
;soft reset patch for Mickey mouse 2, Hugo and Buggs Bunny crazy castle
;-------------------------------------------------------------------------------
